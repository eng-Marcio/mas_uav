...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jason_ros_msgs-msg:<Message> is deprecated: use jason_ros_msgs-msg:Message instead.")))
...
(cl:defmethod data-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jason_ros_msgs-msg:data-val is deprecated.  Use jason_ros_msgs-msg:data instead.")
  (data m))
