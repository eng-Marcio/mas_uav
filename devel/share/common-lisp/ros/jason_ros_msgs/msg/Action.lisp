...
(cl:defmethod cl:initialize-instance :after ((m <Action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jason_ros_msgs-msg:<Action> is deprecated: use jason_ros_msgs-msg:Action instead.")))
...
(cl:defmethod action_name-val ((m <Action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jason_ros_msgs-msg:action_name-val is deprecated.  Use jason_ros_msgs-msg:action_name instead.")
  (action_name m))
