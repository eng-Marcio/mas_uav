...
"""autogenerated by genpy from jason_ros_msgs/Perception.msg. Do not edit."""
import sys
...
class Perception(genpy.Message):
  _md5sum = "547f6a7c40005d1eac4746fdc9b3ee7b"
  _type = "jason_ros_msgs/Perception"
...
string frame_id
"""
  __slots__ = ['header','perception_name','parameters','update']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,perception_name,parameters,update
